...
<body>
    ...
    <div class="kontenedorea d-flex justify-content-center">
        ...
        <div class="divRegistro formLogin d-flex flex-column justify-content-between mx-5">
            ...
            <form id="formRegister" action="<?php echo e(route('web.store')); ?>" method="GET"
            ...
            <a href="<?php echo e(route('web.inicio')); ?>" class="aLogin align-self-center ">LOGIN</a>
...
<?php /**PATH C:\xampp\htdocs\Chemistry-Room\resources\views/web/registro.blade.php ENDPATH**/ ?>