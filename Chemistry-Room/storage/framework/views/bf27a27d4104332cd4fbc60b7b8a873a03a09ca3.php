...
<div id="maskotaBocadillo"class=" d-flex flex-column position-absolute bottom-0 end-0 justify-content-end align-items-center">
        ...
        <img class="bombilla" src="<?php echo e(asset('multimedia/bombilla.svg')); ?>" alt="">

    <img id="maskotaJuego" src="<?php echo e(asset('multimedia/quimica.png')); ?>" alt="">

</div>

<?php /**PATH C:\xampp\htdocs\Chemistry-Room\resources\views/web\layouts\_maskotaFroga.blade.php ENDPATH**/ ?>