<div class=" d-flex flex-column  position-absolute bottom-0 end-0 justify-content-end align-items-center">
         ...
         <div  class="bocadilloPista d-flex justify-content-center">
             ...
             <h2 v-if="mostrar" v-text="mensajes.transicion" class="pistaText p-3 text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est
     ...
     <transition name="aparecer" appear>
            <h2 v-if="mostrar" v-text="mensajes.transicion"></h2>
        </transition>
